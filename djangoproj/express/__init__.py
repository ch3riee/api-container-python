...
def autodiscover(*args):
    ...
    """
    for app in django_apps.get_app_configs():  #contains a registry of installed apps that stores configs and provides introspection. And list of availabkle models.
